...
Sub Clear_Data_Startup()
    ...
    ' First confirmation
    response1 = MsgBox("Are you sure you want to clear data from A11:Q100, S11:T100, and U11:W100?", vbYesNo + vbQuestion, "First Confirmation | DAMO Automation")
    ...
    ws.Range("A11:Q100,S7:T100,U11:W100").ClearContents
...
Sub Clear_Data_Process()
    ...
    ' First confirmation
    response1 = MsgBox("Are you sure you want to clear data from A10:Q54, S7:S54 and U10:U54?", _
    ...
    ws.Range("S7:S54,A10:Q54,U10:U54").ClearContents
